...
public class RadioJD implements Radio{
    //Atributos
    private boolean isOn = false;
    private boolean isFM = true;
    private double emisora = 87.0;
    private Emisora[] ArrayDeEmisoras = new Emisora[11];
    ...
    public void setFavorito(int posicion){
        ...
        this.ArrayDeEmisoras[posicion - 1] = emisora;
    }

    public double getFavorito(int posicion){
        if (ArrayDeEmisoras[posicion - 1] != null){
            setEmisora(ArrayDeEmisoras[posicion - 1].getEstacion());
            setIsFM(ArrayDeEmisoras[posicion - 1].getFrecuencia());
            return this.emisora;
        }
        return this.emisora ;
    }
